...
<head>
    ...
    <link rel="stylesheet" href="./views/bootstrap-5.2.3/dist/css/bootstrap.min.css">
    <!-- <link rel="stylesheet" href="./bootstrap-5.2.3/dist/css/menu.css"> -->
    <link rel="stylesheet" href="./views/bootstrap-5.2.3/dist/css/pages.css">
...
<body>
                    ...
                    <table class="table table-striped table-ls">
                        ...
                        <form action='' method='get'>
                            <tbody>
                                ...
                                <tr>
                                    <td name='name_costumers'><?=$key['name']?></td>
                                    <td name='phone_number_costumers'><?=$key['phone_number']?></td>
                                    <td name='address_costumers'><?=$key['address']?></td>
                                    <td name='email_costumers'><?=$key['email']?></td>
    ...
    <script src="./views/bootstrap-5.2.3/dist/css/bootstrap.css"></script>
    <script src="./views/bootstrap-5.2.3/dist/js/bootstrap.bundle.min.js"></script>
